...
\begin{equation}
    -a\omega_0 \dot{\beta} \langle \cos^2 \psi \rangle + \frac{3}{4}\alpha a^3 \langle \cos^2 \psi \rangle = 0
\end{equation}
Since $\langle \cos^2 \psi \rangle = 1/2$:
\begin{equation}
    -a\omega_0 \dot{\beta} \left(\frac{1}{2}\right) + \frac{3}{8}\alpha a^3 = 0 \implies \dot{\beta} = \frac{3\alpha a^2}{8\omega_0}
\end{equation}
